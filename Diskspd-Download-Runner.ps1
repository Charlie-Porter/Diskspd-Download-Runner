...
Write-Host 'Runing command DiskSpd -t2 -o32 -b4k -r4k -w50 -d5 -Sh -D -L -c1G C:\ProgramData\Kofax\TS\IO.dat > C:\$env:computername-DiskspdResults.txt' -ForegroundColor Green
...
Remove-Item 'C:\ProgramData\Kofax\TS\IO.dat'
Write-Host 'Deleted C:\ProgramData\Kofax\TS\IO.dat ' -ForegroundColor Yellow
